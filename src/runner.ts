      ...
      if (!test.extra) {
        ...
        if (error instanceof Error) {
          ...
          if (error.message.indexOf('regex') != -1) {
            ...
            core.summary.addRaw('', true)
            errors.push(
              `Note: https://www.debuggex.com will take the Expected text in the first box and the Actual text in the second box and show you a red line for where the test fails.`
            )
